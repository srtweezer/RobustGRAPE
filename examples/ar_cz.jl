...
rydberg_cz_parameters_ar = (@set rydberg_cz_parameters_ar.time_limit = 150)
rydberg_cz_parameters_ar = (@set rydberg_cz_parameters_ar.regularization_coeff1 = [1e-5])
rydberg_cz_parameters_ar = (@set rydberg_cz_parameters_ar.regularization_coeff2 = [1e-5])
...
println("Amplitude-error robust gate")
